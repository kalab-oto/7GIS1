...
!!! info    
    Materiály slouží zejména pro sumarizaci jednotlivých cvičení s cílem usnadnit orientaci v předmětu při samostudiu. Pro detailní informace je nutné navštěvovat cvičení, nebo hledat informace v doporučených [zdrojích](zdroje.md). 

## Moodle
Aktuální ročník předmětu je veden na Moodle, kde jsou informace k jednotlivým cvičením, a zejména úkoly:

[KFG/7GIS1 - ZS 25/26](https://moodle.osu.cz/course/view.php?id=10206)
